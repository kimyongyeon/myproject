...
<div class="panel panel-default">
    <div class="panel-heading"><strong>가입완료</strong></div>
    ...
    <div id="result_email" class="well well-sm">
        <span class="badge">아이디</span>
        <strong><?php echo $mb['mb_id'] ?></strong>
        <span class="badge">이메일 주소</span>
    ...
    <div class="panel-footer text-center">
        <a href="<?php echo G5_URL ?>/" class="btn btn-default">메인으로</a>
    </div>
