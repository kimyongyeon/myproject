...
(35, '10', '그룹1', '/bbs/group.php?gr_id=group1', 'self', 0, 1, 1),
(36, '1010', '게시판01', '/bbs/board.php?bo_table=board01', 'self', 0, 1, 1),
(37, '1020', '게시판02', '/bbs/board.php?bo_table=board02', 'self', 0, 1, 1),
(38, '1030', '게시판03', '/bbs/board.php?bo_table=board03', 'self', 0, 1, 1),
(39, '1040', '게시판04', '/bbs/board.php?bo_table=board04', 'self', 0, 1, 1),
(40, '20', '그룹2', '/bbs/group.php?gr_id=group2', 'self', 0, 1, 1),
(41, '2010', '회사소개', '/bbs/content.php?co_id=company', 'self', 0, 1, 1),
(42, '2020', '개인정보 처리방침', '/bbs/content.php?co_id=privacy', 'self', 0, 1, 1),
(43, '2030', '서비스 이용약관', '/bbs/content.php?co_id=provision', 'self', 0, 1, 1);

-- --------------------------------------------------------

--
-- 테이블 구조 `g5_write_board01`
--

CREATE TABLE IF NOT EXISTS `g5_write_board01` (
...
--
-- 테이블 구조 `g5_write_board02`
--

CREATE TABLE IF NOT EXISTS `g5_write_board02` (
  `wr_id` int(11) NOT NULL AUTO_INCREMENT,
  `wr_num` int(11) NOT NULL DEFAULT '0',
  `wr_reply` varchar(10) NOT NULL,
  `wr_parent` int(11) NOT NULL DEFAULT '0',
...
--
-- 테이블 구조 `g5_write_board03`
--

CREATE TABLE IF NOT EXISTS `g5_write_board03` (
  `wr_id` int(11) NOT NULL AUTO_INCREMENT,
  `wr_num` int(11) NOT NULL DEFAULT '0',
  `wr_reply` varchar(10) NOT NULL,
  `wr_parent` int(11) NOT NULL DEFAULT '0',
...
--
-- 테이블 구조 `g5_write_board04`
--

CREATE TABLE IF NOT EXISTS `g5_write_board04` (
  `wr_id` int(11) NOT NULL AUTO_INCREMENT,
  `wr_num` int(11) NOT NULL DEFAULT '0',
  `wr_reply` varchar(10) NOT NULL,
  `wr_parent` int(11) NOT NULL DEFAULT '0',
