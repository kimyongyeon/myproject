...
// 불당님 소스 뷰스킨 이미지 반응형 입히기
$view[content] = preg_replace("/(\<img )([^\>]*)(\>)/i", "\\1 name='target_resize_image[]' onclick='image_window(this)' class='pointer' style='max-width:100% !important; height:auto;' \\2 \\3", $view[content]);
