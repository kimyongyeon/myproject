...
<div class="modal-dialog">
    ...
    <div class="modal-body">
        <div class="well well-sm" style="margin:5px;">
            <?php echo $act ?>할 게시판을 한개 이상 선택하여 주십시오.<br>
        </div>
	...
	<table class="table table-striped table-bordered">
        ...
        <?php for ($i=0; $i<count($list); $i++) {
            ...
            if ($list[$i]['bo_table'] == $bo_table) { // 게시물이 현재 속해 있는 게시판이라면
                $atc_mark = '<span class="label label-info">현재<span class="sound_only">게시판</span></span>';
	...
	<div class="modal-footer">
	    <input type="submit" value="<?php echo $act ?>" id="btn_submit" class="btn btn-danger">
