...
$colspan = 5;
$listall = '<a href="'.$_SERVER['PHP_SELF'].'" class="btn btn-default">처음</a>'; //페이지 처음으로 (초기화용도)
?>

    <form name="fvisit" method="get" onsubmit="return fvisit_submit(this);" class="form-inline" >
    <?=$listall?>
    <div class="form-group">
    <label for="sch_sort" class="sound_only">검색분류</label>
    <select name="sfl" id="sch_sort" class="form-control search_sort">
        ...
        <option value="vi_date"<?php echo get_selected($sfl, 'vi_date'); ?>>날짜</option>
            ...
            <input type="text" name="stx" size="20" value="<?php echo stripslashes($stx); ?>" id="sch_word" class="form-control frm_input" placeholder="Search">
