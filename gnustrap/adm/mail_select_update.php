...
echo "<div class='panel panel-warning'>
        <div class='panel-heading'>
          <h3 class='panel-title'>메일 발송중입니다.</h3>
        </div>
        <div class='panel-body'>
          정상적으로 발송완료 메세지가 나오기 전까지 중지하지마십시오.
        </div>
      </div>";
?>
...
?>
<script> document.all.cont.innerHTML += "<br><br>총 <?php echo number_format($cnt) ?>건 발송<br><br><div class='alert alert-success'>정상으로 발송되었습니다.</div>"; document.body.scrollTop += 1000; </script>
