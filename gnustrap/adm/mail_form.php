...
?>
      <div class="alert alert-info">
        메일 내용에 <strong>{이름} , {닉네임} , {회원아이디} , {이메일}</strong> 처럼 내용에 삽입하면 해당 내용에 맞게 변환하여 메일을 발송합니다.
      </div>
    ...
    <tbody>
		...
		<div class="row">
		        <div class="form-group col-md-12">
                    ...
                    <input type="text" name="ma_subject" value="<?php echo $ma['ma_subject'] ?>" id="ma_subject" required class="form-control required frm_input" size="100">
                </div>
		        <div class="form-group col-md-12">
