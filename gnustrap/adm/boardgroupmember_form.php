...
?>
      ...
      <div class="alert alert-info">
        아이디 <b><?php echo $mb['mb_id'] ?></b>, 이름 <b><?php echo get_text($mb['mb_name']); ?></b>, 닉네임 <b><?php echo $mb['mb_nick'] ?></b>
      </div>

<form name="fboardgroupmember_form" id="fboardgroupmember_form" action="./boardgroupmember_update.php" onsubmit="return boardgroupmember_form_check(this)" method="post" class="form-inline" >
<input type="hidden" name="mb_id" value="<?php echo $mb['mb_id'] ?>" id="mb_id">
<input type="hidden" name="token" value="<?php echo $token ?>" id="token">

    <div class="form-group">
    <label class="sound_only" for="gr_id">그룹지정</label>
    <select name="gr_id" id="gr_id" class="form-control">
     ...
     <button type="submit" class="btn btn-primary" accesskey="s">검색</button>
</form>

<div class="clearfix"></div>
<hr>

<form name="fboardgroupmember" id="fboardgroupmember" action="./boardgroupmember_update.php" onsubmit="return fboardgroupmember_submit(this);" method="post" class="form-inline">
...
<table class="table table-striped table-bordered">
    ...
    if ($i == 0) {
        echo '<tr><td colspan="'.$colspan.'" class="text-center">접근가능한 그룹이 없습니다.</td></tr>';
    }
    ?>
    </tbody>
    </table>
...
<div class="text-center">
    <input type="submit" name="" value="선택삭제" class="btn btn-default">
</div>
</form>
