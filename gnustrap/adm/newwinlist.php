...
<div class="well">전체 <?php echo $total_count; ?>건</div>

<div>
    <a href="./newwinform.php" class="btn btn-primary"><i class="fa fa-plus-circle"></i> 새창관리추가</a>
</div>
...
<div class="table-responsive">
    ...
    <tr>
        ...
        <td style="word-break: break-all;"><?php echo $row['nw_subject']; ?></td>
        ...
        <td>
            <a href="./newwinform.php?w=u&amp;nw_id=<?php echo $row['nw_id']; ?>" class="btn btn-default"><span class="sound_only"><?php echo $row['nw_subject']; ?> </span>수정</a>
            <a href="./newwinformupdate.php?w=d&amp;nw_id=<?php echo $row['nw_id']; ?>" onclick="return delete_confirm();" class="btn btn-default"><span class="sound_only"><?php echo $row['nw_subject']; ?> </span>삭제</a>
        </td>
    </tr>
    <?php
    }
    ...
    if ($i == 0) {
        echo '<tr><td colspan="11" class="text-center">자료가 한건도 없습니다.</td></tr>';
    }
    ?>
    </tbody>
    </table>
