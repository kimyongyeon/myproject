...
<div class="well">
    <?php if ($page > 1) {?><a href="<?php echo $_SERVER['PHP_SELF']; ?>" class="btn btn-default"><i class="fa fa-undo fa-fw"></i>처음으로</a><?php } ?>
...
<div>
    <a href="./contentform.php" class="btn btn-primary"><i class="fa fa-plus-circle fa-fw"></i>내용 추가</a>
</div>
<div class="clearfix"></div>
<hr>
...
<div class="table-responsive">
    ...
    <tr>
        ...
        <td>
            <a href="./contentform.php?w=u&amp;co_id=<?php echo $row['co_id']; ?>" class="btn btn-default"><span class="sound_only"><?php echo htmlspecialchars2($row['co_subject']); ?> </span><i class="fa fa-file-text-o fa-fw"></i>수정</a>
            <a href="<?php echo G5_BBS_URL; ?>/content.php?co_id=<?php echo $row['co_id']; ?>" class="btn btn-default"><span class="sound_only"><?php echo htmlspecialchars2($row['co_subject']); ?> </span><i class="fa fa-eye fa-fw"></i>보기</a>
            <a href="./contentformupdate.php?w=d&amp;co_id=<?php echo $row['co_id']; ?>" onclick="return delete_confirm();" class="btn btn-default"><span class="sound_only"><?php echo htmlspecialchars2($row['co_subject']); ?> </span><i class="fa fa-cut fa-fw"></i>삭제</a>
        </td>
    </tr>
    <?php
    }
    if ($i == 0) {
        echo '<tr><td colspan="3" class="text-center">자료가 한건도 없습니다.</td></tr>';
    }
    ?>
    </tbody>
    </table>
