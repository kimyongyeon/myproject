...
<table class="table table-striped table-bordered" style="max-width:100%; min-width:650px;">
    ...
    ?>
    <tr class="menu_list menu_group_<?php echo substr($row['me_code'], 0, 2); ?>">
        ...
        <td>
            ...
            <input type="text" name="me_link[]" value="<?php echo $row['me_link'] ?>" id="me_link_<?php echo $i; ?>" required class="required form-control full_input">
        </td>
        <td>
        ...
        <td>
            ...
            <input type="text" name="me_order[]" value="<?php echo $row['me_order'] ?>" id="me_order_<?php echo $i; ?>" class="form-control" size="5">
        </td>
        <td>
