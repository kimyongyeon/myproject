...
<div class="well well-sm">
    ...
    <p>
        이 작업을 실행하기 전에 <a href="<?php echo G5_SMS5_ADMIN_URL; ?>/member_update.php" target="_blank" class="btn btn-warning">회원정보업데이트</a>를 먼저 실행해주세요.
    </p>
</div>

<form name="upload_form" method="post" enctype="multipart/form-data" id="sms5_fileup_frm">
<div>
    <select name="upload_bg_no" id="upload_bg_no" class="form-control">
...
<div id="sms5_fileup">
    ...
    <input type="file" name="csv" id="csv" onchange="document.getElementById('upload_info').style.display='none';" class="form-control">
    <span id="upload_button">
    <input type="button" value="파일전송" onclick="upload();" class="btn btn-default" style="margin-top:15px;">
    </span>
    <span id="uploading" class="sms_fileup_hide">
        <input class="form-control" id="disabledInput" type="text" placeholder="파일을 업로드 중입니다. 잠시만 기다려주세요." disabled style="margin:10px; 0;">
    </span>

    <div id="upload_info" class="sms_fileup_hide"></div>
    <div id="register" class="sch_last sms_fileup_hide">
        <input class="form-control" id="disabledInput" type="text" placeholder="휴대폰번호를 DB에 저장중 입니다. 잠시만 기다려주세요." disabled style="margin:10px; 0;">
    </div>
</div>
</form>
...
<div class="well well-sm">
    <p>
        ...
        <label class="btn btn-default" for="no_hp" style="margin-top:10px;">
		<input type="checkbox" value="1" id="no_hp" data-toggle="checkbox">
        휴대폰 번호 없는 회원 포함</label>
        <label class="btn btn-default" for="hyphen" style="margin-top:10px;">
		<input type="checkbox" value="1" id="hyphen" data-toggle="checkbox">
        하이픈 '―' 포함</label>
...
<div class="input-group">
    <select name="download_bg_no" id="download_bg_no" class="form-control">
        <option value="">그룹선택</option>
    ...
    <span class="input-group-btn">
       <button class="btn btn-default" type="button" onclick="download()" >다운로드</button>
    </span>
</div>
