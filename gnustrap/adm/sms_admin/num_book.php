...
<form name="search_form" class="pull-left" style="margin-bottom:15px;">
    <label for="bg_no" class="sound_only">그룹명</label>
    <select name="bg_no" id="bg_no" onchange="location.href='<?php echo $_SERVER['PHP_SELF']?>?bg_no='+this.value;" class="form-control">
...
<div class="pull-right" style="margin-left:10px;">
    <a href="./num_book_write.php?page=<?php echo $page?>&amp;bg_no=<?php echo $bg_no?>" class="btn btn-default">번호추가</a>
</div>
...
<table class="table table-striped table-bordered">
    ...
    <tr>
        ...
        <td>
            <a href="./num_book_write.php?w=u&amp;bk_no=<?php echo $res['bk_no']?>&amp;page=<?php echo $page?>&amp;bg_no=<?php echo $bg_no?>&amp;st=<?php echo $st?>&amp;sv=<?php echo $sv?>&amp;ap=<?php echo $ap?>" class="btn btn-default">수정</a>
            <a href="./sms_write.php?bk_no=<?php echo $res['bk_no']?>" class="btn btn-default">보내기</a>
            <a href="./history_num.php?st=hs_hp&amp;sv=<?php echo $res['bk_hp']?>" class="btn btn-default">내역</a>
        </td>
    </tr>
    <?php } ?>
    </tbody>
...
<label class="btn btn-default" for="no_hp" style="margin-bottom:10px;">
<input type="checkbox" name="no_hp" id="no_hp" <?php echo $no_hp_checked?> onclick="no_hp_click(this.checked)" data-toggle="checkbox">
휴대폰 소유자만 보기</label>
<div class="pull-right">
    <input type="submit" name="act_button" value="선택삭제" onclick="document.pressed=this.value" class="btn btn-default">
    <input type="submit" name="act_button" value="수신허용" onclick="document.pressed=this.value" class="btn btn-default">
    <input type="submit" name="act_button" value="수신거부" onclick="document.pressed=this.value" class="btn btn-default">
    <input type="submit" name="act_button" value="선택이동" onclick="document.pressed=this.value" class="btn btn-default">
    <input type="submit" name="act_button" value="선택복사" onclick="document.pressed=this.value" class="btn btn-default">
</div>
</form>
<script>
