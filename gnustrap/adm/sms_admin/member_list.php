...
$listall = '<a href="'.$_SERVER['PHP_SELF'].'" class="btn btn-default">전체목록</a>';
...
<table class="table table-striped table-bordered">
    ...
    <tr>
        ...
        <th scope="col" rowspan="2" id="mb_list_mng" style="width:70px;">관리</th>
    </tr>
    <tr>
...
<?php
    for ($i=0; $row=sql_fetch_array($result); $i++) {
        ...
        if ($is_admin == 'group') {
            ...
            $s_mod = '<a href="./member_form.php?'.$qstr.'&amp;w=u&amp;mb_id='.$row['mb_id'].'" class="btn btn-default">수정</a>';
            //$s_del = '<a href="javascript:post_delete(\'member_delete.php\', \''.$row['mb_id'].'\');">삭제</a>';
        }
        $s_grp = '<a href="./boardgroupmember_form.php?mb_id='.$row['mb_id'].'" class="btn btn-default">그룹</a>';
