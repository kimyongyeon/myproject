...
<form class="navbar-form navbar-left" role="search" name="search_form" id="search_form" action=<?php echo $_SERVER['PHP_SELF'];?> method="get">
...
<table class="table table-striped table-bordered">
    ...
    <tr>
        ...
        <td><?php echo $res['wr_booking']!='0000-00-00 00:00:00'?"<span title='{$res['wr_booking']}' class='btn btn-default'>예약</span>":'';?></td>
